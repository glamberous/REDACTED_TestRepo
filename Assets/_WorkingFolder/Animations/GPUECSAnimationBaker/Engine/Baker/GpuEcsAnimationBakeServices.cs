...
namespace GPUECSAnimationBaker.Engine.Baker
{
    public static class GpuEcsAnimationBakerServices
    {
            ...
            ) 
        {
            ...
            MyGpuEcsAnimatorObject asset = ScriptableObject.CreateInstance<MyGpuEcsAnimatorObject>();
            asset.animations = gpuEcsAnimator.animations;
            asset.totalNbrOfFrames = gpuEcsAnimator.totalNbrOfFrames;
            asset.nbrOfAttachmentAnchors = gpuEcsAnimator.nbrOfAttachmentAnchors;
            asset.attachmentAnchorData = gpuEcsAnimator.attachmentAnchorData;
            asset.transformUsageFlags = gpuEcsAnimator.transformUsageFlags;
            asset.animationEventOccurences = gpuEcsAnimator.animationEventOccurences;

            AssetDatabase.CreateAsset(asset, generatedAssetsFolder + "/GpuEcsData.asset");
        ...
        private const string enumFileTemplate = "namespace Display\n"
                                                + "{\n"
        ...
        private const string behaviourFileTemplate = "using Display;\n"
        ...
        {
            GenerateEnumCodeFiles<AnimationData>($"AnimationID_{bakerData.animationIdsEnumName}", "GpuEcsAnimatorInitializer",
