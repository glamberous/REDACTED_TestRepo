...
Shader "SyntyStudios/VegitationShader_MyCustom"
{
	Properties
	{
		...
		_MyLighting("MyLighting", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _LeafTex;
			sampler2D _TunkTex;
			UNITY_INSTANCING_BUFFER_START(SyntyStudiosVegitationShader_MyCustom)
				UNITY_DEFINE_INSTANCED_PROP(float4, _LeafTex_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _TunkTex_ST)
				UNITY_DEFINE_INSTANCED_PROP(float, _MyLighting)
			UNITY_INSTANCING_BUFFER_END(SyntyStudiosVegitationShader_MyCustom)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 transform691 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				...
				float3 vertexValue = ( step( transform691.y , ( _CameraHeight + 1.0 ) ) * ( Jitter68 + float4( Wind201 , 0.0 ) ) ).rgb;
				 ...
				 ) : SV_Target
			{
				...
				float4 _LeafTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_LeafTex_ST);
				float2 uv_LeafTex = IN.ase_texcoord4.xy * _LeafTex_ST_Instance.xy + _LeafTex_ST_Instance.zw;
				float4 _TunkTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_TunkTex_ST);
				float2 uv_TunkTex = IN.ase_texcoord4.xy * _TunkTex_ST_Instance.xy + _TunkTex_ST_Instance.zw;
				...
				float _MyLighting_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_MyLighting);
				...
				float dither672 = Dither4x4Bayer( fmod(clipScreen672.x, 4), fmod(clipScreen672.y, 4) );
				float4 transform691 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float smoothstepResult675 = smoothstep( ( transform691.y - 1.0 ) , transform691.y , ( _CameraHeight + 1.0 ));
				dither672 = step( dither672, ( smoothstepResult675 * 2.0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( Albedo78 * _MyLighting_Instance ).rgb;
				float Alpha = ( Alpha77 * dither672 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _LeafTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_LeafTex_ST);
				float2 uv_LeafTex = IN.ase_texcoord3.xy * _LeafTex_ST_Instance.xy + _LeafTex_ST_Instance.zw;
				float4 _TunkTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_TunkTex_ST);
				float2 uv_TunkTex = IN.ase_texcoord3.xy * _TunkTex_ST_Instance.xy + _TunkTex_ST_Instance.zw;
				float4 temp_output_551_0 = ( IN.ase_color.b > 0.5 ? tex2D( _LeafTex, uv_LeafTex ) : tex2D( _TunkTex, uv_TunkTex ) );
				float Alpha77 = temp_output_551_0.a;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 _LeafTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_LeafTex_ST);
				float2 uv_LeafTex = IN.ase_texcoord.xy * _LeafTex_ST_Instance.xy + _LeafTex_ST_Instance.zw;
				float4 _TunkTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_TunkTex_ST);
				float2 uv_TunkTex = IN.ase_texcoord.xy * _TunkTex_ST_Instance.xy + _TunkTex_ST_Instance.zw;
				float4 temp_output_551_0 = ( IN.ase_color.b > 0.5 ? tex2D( _LeafTex, uv_LeafTex ) : tex2D( _TunkTex, uv_TunkTex ) );
				float Alpha77 = temp_output_551_0.a;
				...
				surfaceDescription.Alpha = ( Alpha77 * dither672 );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float4 _LeafTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_LeafTex_ST);
				float2 uv_LeafTex = IN.ase_texcoord2.xy * _LeafTex_ST_Instance.xy + _LeafTex_ST_Instance.zw;
				float4 _TunkTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SyntyStudiosVegitationShader_MyCustom,_TunkTex_ST);
				float2 uv_TunkTex = IN.ase_texcoord2.xy * _TunkTex_ST_Instance.xy + _TunkTex_ST_Instance.zw;
				float4 temp_output_551_0 = ( IN.ase_color.b > 0.5 ? tex2D( _LeafTex, uv_LeafTex ) : tex2D( _TunkTex, uv_TunkTex ) );
				float Alpha77 = temp_output_551_0.a;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-3100.517,1215.123;Inherit;False;Property;_WindDirection;WindDirection;25;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;179;-4213.904,929.6496;Inherit;False;Property;_GustSmallFreq;GustSmallFreq;29;0;Create;True;0;0;0;False;0;False;1;0.184;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;283;-3794.424,767.774;Inherit;False;Property;_GustScale;GustScale;32;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;587;-2888.277,-1328.446;Inherit;True;Property;_Vert;Vert;46;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;309;-4102.317,1299.284;Inherit;False;Property;_GustLargeFreq;GustLargeFreq;30;0;Create;True;0;0;0;False;0;False;0.5;0.184;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;182;-3508.32,1042.211;Inherit;True;Property;_GustNoiseMap;GustNoiseMap;31;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-3473.978,417.0614;Inherit;False;Property;_GustAmount;GustAmount;28;0;Create;True;0;0;0;False;0;False;0.5;0.394;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-2911.025,865.0797;Inherit;False;Property;_WindBaseline;WindBaseline;26;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;119;-3937.008,41.5755;Inherit;False;Property;_LeafBigNoiseScale;LeafBigNoiseScale;34;1;[Header];Create;True;1;LeafSway;0;0;False;0;False;1;2.35;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-3643.385,-562.1201;Float;False;Property;_JitterFreq;JitterFreq;36;1;[Header];Create;True;1;LeafJitter;0;0;False;0;False;0;0.575;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2200.979,1185.864;Inherit;False;Property;_TotalWindAmount;TotalWindAmount;24;1;[Header];Create;True;1;Main Wind;0;0;False;0;False;0.5;0.229;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;136;-3001.445,42.98514;Inherit;False;Property;_LeafBigNoiseAmount;LeafBigNoiseAmount;35;0;Create;True;0;0;0;False;0;False;0.5;0.093;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;46;-2805.407,-650.3812;Inherit;True;Property;_Leaves_NoiseTexture2;LeafJitterMap;38;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TexturePropertyNode;589;-2883.199,-1833.299;Inherit;True;Property;_Albedo;Albedo;45;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;148;-2393.851,785.3052;Inherit;False;Property;_Y_multiplier;Y_multiplier;27;0;Create;True;0;0;0;False;0;False;0.2;0.2;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-2706.617,-433.0301;Float;False;Property;_JitterAmount;JitterAmount;37;0;Create;True;0;0;0;False;0;False;0.5;0.445;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;674;-1472,192;Inherit;False;Constant;_Float0;Float 0;47;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;671;-1520,-128;Inherit;False;Global;_CameraHeight;_CameraHeight;47;0;Create;True;0;0;0;False;0;False;20;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;691;-1488,-32;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;550;-1049.25,-1955.424;Inherit;True;Property;_TunkTex;TunkTex;3;1;[Header];Create;True;1;Trunk;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TransformDirectionNode;239;-2080,256;Inherit;False;World;Object;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;673;-1248,-64;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;692;-1232,-176;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;675;-1040,-96;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;677;-1024,80;Inherit;False;Constant;_Float1;Float 1;47;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;203;-720,352;Inherit;False;201;Wind;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;202;-720,272;Inherit;False;68;Jitter;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;683;-848,176;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;676;-832,-48;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;204;-512,320;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;681;-656,160;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;672;-656,-48;Inherit;False;0;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;199;-720,-160;Inherit;False;77;Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;503;-1422.588,-926.1651;Inherit;False;Property;_ColourNoiseLargeScale;ColourNoiseLargeScale;13;0;Create;True;0;0;0;False;0;False;0;0.368;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-1395.763,-1354.44;Inherit;False;Property;_ColourNoiseSmallScale;ColourNoiseSmallScale;12;0;Create;True;0;0;0;False;0;False;0;0.748;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;63;-1009.043,-1544.865;Inherit;False;Property;_LeafBaseColour;LeafBaseColour;5;1;[Header];Create;True;1;Colour Tinting;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;507;-441.8385,-1473.494;Inherit;False;Property;_LeafNoiseLargeColour;LeafNoiseLargeColour;7;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;65;-1005.823,-1722.327;Inherit;False;Property;_LeafNoiseColour;LeafNoiseColour;6;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;437;-3737.298,1909.813;Inherit;False;Property;_PulseSpeed;PulseSpeed;23;0;Create;True;0;0;0;False;0;False;0.04;0.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;496;-20.08881,-1880.129;Inherit;False;Property;_FrostingHeight;FrostingHeight;41;0;Create;True;0;0;0;False;0;False;1;9.59;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;377;-350.6857,-1259.393;Inherit;False;Property;_GustHighlight;GustHighlight;33;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.135055,0.1509434,0.1288714,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;442;-3459.298,1795.813;Inherit;False;Property;_PulseTiling;PulseTiling;22;0;Create;True;0;0;0;False;0;False;0.03;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;454;-3717.798,2920.447;Inherit;True;Property;_Emissive2Mask;Emissive2Mask;17;0;Create;True;1;Emissive;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;601;210.7666,-1331.584;Inherit;False;Property;_LeafFlatColourSwitch;LeafFlatColourSwitch;8;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;200;-3719.584,2630.946;Inherit;True;Property;_EmissiveMask;EmissiveMask;15;0;Create;True;1;Emissive;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;471;73.17218,-1773.063;Inherit;False;Property;_FrostingFalloff;FrostingFalloff;42;0;Create;True;1;Triplanar;0;0;False;0;False;1;4.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;419;-3194.918,2652.3;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;566;-3637.677,3184.796;Inherit;True;Property;_TrunkEmissiveMask;TrunkEmissiveMask;20;0;Create;True;1;Emissive;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;418;-3415.918,2537.3;Inherit;False;Property;_EmissiveColour;EmissiveColour;16;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;218;-213.7214,-718.5309;Inherit;False;Property;_TrunkBaseColour;TrunkBaseColour;9;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0.07843132,0.02015968,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;456;-3416.132,2826.801;Inherit;False;Property;_Emissive2Colour;Emissive2Colour;18;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;217;-208.499,-900.8921;Inherit;False;Property;_TrunkNoiseColour;TrunkNoiseColour;10;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0.07843132,0.02015968,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;433;-2998.298,1902.813;Inherit;True;Property;_EmissivePulseMap;EmissivePulseMap;21;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;481;473.7535,-2131.432;Inherit;False;Property;_FrostingColour;FrostingColour;39;1;[Header];Create;True;1;Frosting;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;568;-3336.011,3091.15;Inherit;False;Property;_TrunkEmissiveColour;TrunkEmissiveColour;19;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;604;617.2565,-1268.986;Inherit;False;Property;_FrostingSwitch;FrostingSwitch;40;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;602;306.557,-741.8369;Inherit;False;Property;_TrunkFlatColourSwitch;TrunkFlatColourSwitch;11;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;209;-3411.365,2726.882;Inherit;False;Property;_EmissiveAmount;EmissiveAmount;14;1;[Header];Create;True;1;Emissive;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;78;1152,-1520;Inherit;False;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;582;-1198.813,939.0795;Inherit;True;Property;_TrunkAmbientOcclusion;TrunkAmbientOcclusion;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TexturePropertyNode;591;-2888.276,-1585.007;Inherit;True;Property;_Normal;Normal;44;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;286;-1198.322,738.4786;Inherit;True;Property;_LeafAmbientOcclusion;LeafAmbientOcclusion;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;658;-82.03173,-2382.628;Inherit;False;Property;_FrostingWorldObjectSwitch2;FrostingWorldObjectSwitch;43;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;614;-144,608;Inherit;False;Property;_AlphaClip;AlphaClip;0;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;682;-368,288;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;685;-256,-288;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;684;-496,-256;Inherit;False;InstancedProperty;_MyLighting;MyLighting;47;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;687;-416,-80;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldToObjectTransfNode;670;-1168,-320;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;198;-496,-336;Inherit;False;78;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;660;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;661;41.30931,209.989;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;SyntyStudios/VegitationShader_MyCustom;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;638635680928015733;Forward Only;0;638635677286987204;Cast Shadows;0;638635692869246673;  Use Shadow Threshold;0;0;Receive Shadows;0;638635677131441848;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;662;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;663;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;664;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;665;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;666;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;SceneSelectionPass;0;6;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;667;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ScenePickingPass;0;7;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;668;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthNormals;0;8;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;669;41.30931,209.989;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthNormalsOnly;0;9;DepthNormalsOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;;0;0;Standard;0;False;0
...
WireConnection;673;0;691;2
WireConnection;673;1;674;0
WireConnection;692;0;671;0
WireConnection;692;1;674;0
WireConnection;201;0;239;0
WireConnection;68;0;64;0
WireConnection;555;0;551;0
WireConnection;675;0;692;0
WireConnection;675;1;673;0
WireConnection;675;2;691;2
WireConnection;683;0;671;0
WireConnection;683;1;674;0
...
WireConnection;682;1;204;0
WireConnection;685;0;198;0
WireConnection;685;1;684;0
WireConnection;687;0;199;0
WireConnection;687;1;672;0
WireConnection;661;2;685;0
WireConnection;661;3;687;0
WireConnection;661;4;614;0
WireConnection;661;5;682;0
ASEEND*/
//CHKSM=2F4189690705C978CB01EC44A9E2B32F16090FDB